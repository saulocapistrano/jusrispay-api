...
public class NotificationGenerationScheduler {
    ...
    @Scheduled(fixedDelayString = "${jurispay.scheduler.notifications.generate.fixed-delay-ms:60000}")
    public void generate() {
        ...
        LocalTime dispatchTime = config.getReminderDispatchTime();
        ...
        generateReceivableNotificationsUseCase.generateReminders();
